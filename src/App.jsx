...
const Marquee = () => {
  return (
    <div className="w-full py-12 bg-cyan-900/10 border-y border-cyan-500/20 overflow-hidden relative">
      ...
      >
        {[...Array(4)].map((_, i) => (
          <div key={i} className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white/10 to-white/5 uppercase px-8">
...
const Services = () => {
  const services = [
    ...
    { icon: <Monitor size={32} />, title: "Post-Production", desc: "Professional editing, color grading, and VFX compositing." },
    { icon: <Cpu size={32} />, title: "3D Motion", desc: "Abstract 3D assets and motion graphics for modern brands." },
  ];
    ...
    <section id="contact" className="py-32 bg-zinc-950 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-400 text-lg">Let's build something impossible together.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 bg-black/50 p-8 md:p-12 border border-white/10 backdrop-blur-sm">
          ...
          <div className="space-y-8">
             ...
             <div className="flex items-center gap-4 text-gray-300 hover:text-cyan-400 transition-colors cursor-pointer">
                ...
                <span>hello@nexus.visuals</span>
             </div>
             <div className="flex items-center gap-4 text-gray-300 hover:text-cyan-400 transition-colors cursor-pointer">
                <Globe className="h-5 w-5" />
                <span>www.nexus.visuals</span>
             </div>

             <div className="pt-8 flex gap-4">
                {[Instagram, Twitter, Video].map((Icon, i) => (
                  <motion.button 
                    key={i}
                    whileHover={{ y: -5, color: '#22d3ee' }}
                    className="p-3 rounded-none border border-white/10 text-white transition-colors"
                  >
                     <Icon size={20} />
                  </motion.button>
                ))}
...
const Footer = () => (
  <footer className="bg-black py-8 border-t border-white/10 text-center relative z-10">
    <p className="text-gray-600 text-xs tracking-widest uppercase">© 2024 NEXUS VISUALS SYSTEM. ALL RIGHTS RESERVED.</p>
  </footer>
);
